...
/// @param methodName Instance method name. Should be a format: @"methodname:arg1:arg2"
/// @param arguments An Array of arguments for the method
- (id)callInstanceMethodWithReturnBoxingPrimitives: (NSString *)methodName
                                                       args: (NSArray<id> *)arguments;
...
/// Call a class method reflectively
/// @param methodName Class method name. Should be a format: @"methodname:arg1:arg2"
/// @param arguments An Array of arguments for the method
- (nullable id)callClassMethodWithReturnBoxingPrimitives: (NSString *)methodName
                                                    args: (NSArray<id> *)arguments;
